...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'announcement-bar-8', // increment on change
      content: `Conduit v0.13.1 is here! <a class='cta' href='/changelog/2025-02-06-conduit-0-13-1-release' target='_blank' rel='noreferrer noopener'>See what's new</a>.`,
      isCloseable: true,
    },
    colorMode: {
      defaultMode: 'light',
