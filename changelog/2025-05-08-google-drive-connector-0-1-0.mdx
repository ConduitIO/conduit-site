...
draft: false
tags: [conduit, connector, google-drive, release, connector-release]
---
...
:::tip
For detailed setup and configuration instructions, refer to our [documentation](/docs/using/connectors/list/google-drive).
:::
