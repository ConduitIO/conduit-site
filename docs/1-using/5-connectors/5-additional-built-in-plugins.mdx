...
:::note
For the purpose of this example, we're going to add the [Conduit Snowflake connector](https://github.com/conduitio-labs/conduit-connector-snowflake) to Conduit as a [built-in connector](/docs/core-concepts#built-in-connector), and we're going to name our application `custom-conduit-app` pushed to `github.com/conduitio-labs`.
:::
...
Once you have confirmed that your Conduit Connector is available in your application, you are ready to transfer your pipelines to the custom Conduit application and 
