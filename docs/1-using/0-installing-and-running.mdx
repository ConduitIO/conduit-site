...
Let's say you downloaded `conduit_0.13.2_Windows_x86_64.zip`.

### Unzip the archive

```shell
tar -xf conduit_0.13.2_Windows_x86_64.zip
```
...
```shell
$ TAG=v0.13.2; curl -o conduit.tar.gz -L https://github.com/ConduitIO/conduit/archive/refs/tags/$TAG.tar.gz
```
