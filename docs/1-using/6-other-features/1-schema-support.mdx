...
Every [record](/docs/core-concepts/opencdc-record) that contains structured
...
the [key schema](/docs/core-concepts/opencdc-record#opencdckeyschema)'s subject and
version as well
the [payload schema](/docs/core-concepts/opencdc-record#opencdcpayloadschema)'s
...
and [processors](/docs/using/processors//standalone/building#schemas).
