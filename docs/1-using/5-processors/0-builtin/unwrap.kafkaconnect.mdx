...
Unwraps a Kafka Connect record from an [OpenCDC record](https://conduit.io/docs/core-concepts/opencdc-record).

## Description

This processor unwraps a Kafka Connect record from the input [OpenCDC record](https://conduit.io/docs/core-concepts/opencdc-record).
...
In such cases, the Debezium record is set as the [OpenCDC record](https://conduit.io/docs/core-concepts/opencdc-record)'s payload, and needs to be unwrapped for further usage.
...
The Kafka Connect record's payload will replace the [OpenCDC record](https://conduit.io/docs/core-concepts/opencdc-record)'s payload.
