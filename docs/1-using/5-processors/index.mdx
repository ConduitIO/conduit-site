...
- [Standalone processors](/docs/using/processors//standalone) are the ones you could write yourself to do anything that's not already covered by the [Built-in](/docs/using/processors//builtin) ones. [Here's](/docs/using/processors//standalone) more information about them.

## How to use a processor

In these following examples, we're using the [`json.decode`](/docs/using/processors/builtin/json.decode), but you could use any other you'd like from our [Built-in](/docs/using/processors//builtin/) ones, or even [reference](/docs/using/processors//referencing) your own [Standalone processor](/docs/using/processors//standalone).  
