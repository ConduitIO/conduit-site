...
<div style={{ textAlign: "center" }}>
  <img alt="Amazon S3" style={{ maxWidth: "500px" }} src="/images/resources/amazon-s3.png" />
</div>
...
* CDC mode: this mode iterates through the S3 bucket every `polling-period` and captures
  ...
  As an example: "thisIsAKey_c1634049397". This position is used to return only the actions with a _lastModifiedDate_ higher than
