...
For an ARM based back Mac for example we'd grab the `conduit_0.11.1_Darwin_arm64.tar.gz` archive.

### unzip the archive

```shell
tar xzvf conduit_0.11.1_Darwin_arm64.tar.gz
```
...
learn [how to build a pipeline](/docs/how-to/build-generator-to-file-pipeline).
