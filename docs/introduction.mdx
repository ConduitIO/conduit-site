...
To get started make sure you download the latest version of Conduit using one of our available options.

<a href="/docs/getting-started/installing-and-running" className="inline-flex items-center px-4 py-2 font-bold border border-transparent rounded-md shadow-sm text-sm text-white bg-gray-600 hover:bg-gray-700 hover:text-white outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500">Install Conduit</a>
