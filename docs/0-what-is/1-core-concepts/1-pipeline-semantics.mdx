...
import PipelineExample from '@site/src/components/PipelineExample';
...
- Conduit is using gRPC streams to communicate with [standalone connectors](/docs/core-concepts#standalone-connector), which internally buffers requests before
