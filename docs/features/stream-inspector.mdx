...
Stream inspection is available via the Conduit UI and the API. To learn how to use it, please visit our [stream inspector guide](/guides/2022-12-15-stream-inspector).
