...
Pipeline Recovery is enabled by default since Conduit v0.12. The feature can
...
## Disabling Pipeline Recovery

To disable Pipeline Recoveery, you should set the configuration parameter
