...
Contains the subject and version of the schema for the records's `.Key` field.
...
Contains the subject and version of the schema for the records's `.Payload` field.
