...
### `opencdc.key.schema.version`, `opencdc.payload.schema.version`

Contains the version of the schema of the record.
...
### `opencdc.key.schema.subject`, `opencdc.payload.schema.subject`

Contains the subject of the schema of the record.
