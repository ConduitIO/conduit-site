---
title: 'Developing custom processors'
---
...
Thanks to our [Web Assembly (Wasm) processor](/docs/using/processors//standalone/how-it-works) you can start writing processors in any language that can be compiled to Web Assembly. As a start, Conduit already provides a [conduit-processor-sdk](https://github.com/ConduitIO/conduit-processor-sdk) that will let you [write a processor](/docs/using/processors//standalone/building) in Go.
