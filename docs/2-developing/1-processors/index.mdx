...
Run [`conduit processor new <name>`](/docs/developing/connectors/scaffold-new) to
scaffold a building, git-initialized Go processor project in one command, or
start from the [Conduit processor template](/docs/developing/processors/conduit-processor-template)
directly.
...
![scarf pixel conduit-site-docs-developing-processors](https://static.scarf.sh/a.png?x-pxid=3108abd7-7971-40bd-a92e-87c4f2562fe6)