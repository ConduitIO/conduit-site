...
:::tip
If you'd rather not leave the terminal, [`conduit processor new`](/docs/developing/connectors/scaffold-new)
drives this same template for you — module rename, code generation, a verified
build, and git init — from one command. The steps below are what it automates;
use them directly if you want to start from GitHub's "Use this template" button
instead.
:::
...
- [Build your own](/docs/developing/processors/building)
