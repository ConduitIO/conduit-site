...
and request a specific language SDK. You can also read [how standalone processors work](/docs/using/processors//standalone/how-it-works)
...
Check [Standalone processors](/docs/using/processors//standalone/#where-to-put-them) for details on how to use your standalone
