...
Start by downloading the binary for the [latest release](https://github.com/ConduitIO/conduit/releases/latest) on Conduit's Release page. Make sure that you pick the installation that matches the architecture of your machine.
