...
For an ARM based back Mac for example we'd grab the `conduit_0.9.0_Darwin_arm64.tar.gz` archive.
### unzip the archive
```shell
tar xzvf conduit_0.9.0_Darwin_arm64.tar.gz
```
