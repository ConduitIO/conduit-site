...
by the [`json.decode` builtin processsor](/docs/processors/builtin/json.decode) when
he [OpenCDC Metadata](/docs/features/opencdc-record#fields) contains a key named
