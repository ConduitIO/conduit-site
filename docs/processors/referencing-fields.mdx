...
the [OpenCDC format](/docs/features/opencdc-record.mdx)). That is done through
...
but it can also be a nested field, as we will see in examples below.

To reference one of the OpenCDC record fields, following should be used:
