...
Currently Conduit supports different types of processors:

- [Built-in processors](/docs/processors/builtin) that will perform the most common operations you could expect such as filtering fields, replacing fields, posting payloads to a HTTP endpoint, etc. 
- [Custom processors](/docs/processors/standalone-processors) are the ones you could write yourself to do anything that's not already covered by the [Built-in](/docs/processors/builtin) ones.
