...
by configuring the processor to use 200 workers, we can execute the slow
operation concurrently on 200 records at a time. This enables us to easily
process 100 records per second and provides some room for handling larger
bursts.
