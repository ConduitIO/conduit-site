...
```shell
tar zxvf conduit_0.9.0_Darwin_x86_64.tar.gz
```
...
Now that we have Conduit up and running you can now navigate to `http://localhost:8080` to check this admin UI:
