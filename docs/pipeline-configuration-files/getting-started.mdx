...
Inside of that folder create a file named `source-to-destination.yml`.
...
### Choose your source connector

TODO: Include a list of source connectors here. Save which one is selected so it's sent to the react component.

### Choose your destination connector

TODO: Include a list of destination connectors here. Save which one is selected so it's sent to the react component.
