...
import DocumentedConnector from '@site/src/components/ConnectorList/DocumentedConnector';
  ...
  render() {
    ...
    return (
      <>
        ...
        />
        {connectors.map(conn => (
            conn.conduitIODocsPage ? (
                <DocumentedConnector key={conn.url} connector={conn} />
            ) : (
