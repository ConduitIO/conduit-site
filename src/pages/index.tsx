          ...
          <Wrapper className="py-2 pb-10">
              <SplitPair>
                  <div className="flex-1 items-start flex flex-col">
                      <h2 className='text-4xl font-bold pb-10 text-white'>Get up.<br/>Get involved. <br/>Get into it.
                      </h2>
                      <p className="pb-10 text-md text-white">The Conduit Community is the ultimate resource of
                          information to help you get started and optimize your infrastructure to build and deploy
                          connectors.</p>
                      <div>
                          <a href="https://github.com/ConduitIO/conduit"
                          ...
                          >
                              <svg aria-hidden="true" width="33" height="25" fill="none"
                                   xmlns="http://www.w3.org/2000/svg">
                                  <g clipPath="url(#a)">
                                      <path
                  ...
                  <div className="flex-1 items-center flex">
                      <img className="w-full h-46 md:h-96 mx-auto" src="/img/conduit/big-data-storage.svg"
                           alt="Data Transformation Visual"/>
                  </div>
              </SplitPair>
          </Wrapper>
