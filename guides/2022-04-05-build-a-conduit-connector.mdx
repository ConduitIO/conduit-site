...
We are implmenting a Conduit connector that will be able to index data into Algolia. This will allow users to move data from any [Conduit Source](/docs/connectors/overview) to Algolia. This connector will be a destination connector.
