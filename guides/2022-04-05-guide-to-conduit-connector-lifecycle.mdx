...
The goal of Conduit is to have the best experience when it comes to building connectors. The Conduit Connector Lifecyle describes the the methods Conduit will call during the life of a connector.
...
`Read` returns a new [Record](https://pkg.go.dev/github.com/conduitio/conduit-connector-sdk#Record) and is supposed to block until there is either
