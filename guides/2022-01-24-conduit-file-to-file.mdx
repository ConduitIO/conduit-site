...
![Kafka to Postgres Conduit Pipeline](/images/guides/file-to-file.png)
...
<div style={{ textAlign: "center" }}>
  <img alt="Kafka Configuration" className="rounded-lg" style={{ maxWidth: "800px", margin: 'auto' }} src="/images/guides/moving-data-between-files-with-conduit/add-connector.png" />
</div>
...
<div style={{ textAlign: "center" }}>
  <img alt="Full Conduit Pipeline" className="rounded-lg" style={{ maxWidth: "800px", margin: 'auto' }} src="/images/guides/moving-data-between-files-with-conduit/pipeline.png" />
</div>
